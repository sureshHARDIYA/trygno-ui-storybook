import{I as t}from"./constants-D6BqK3Cp.js";const c={title:"Components/Core/Icon",component:"trygno-icon",tags:["autodocs"],argTypes:{name:{options:t.sort(),control:{type:"select"}},label:{control:{type:"text"}}},parameters:{docs:{page:null}}},r=({name:o,label:n})=>`
    <p>${o}</p>
    <trygno-icon
      name="${o}"
      label="${n}"
