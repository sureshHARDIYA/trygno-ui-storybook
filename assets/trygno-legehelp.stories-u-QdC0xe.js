const d={title:"Components/Shared/Legehelp",component:"trygno-legehelp",tags:["autodocs"],argTypes:{isHorizontallyCentered:{control:{type:"boolean"}},maxWidth:{control:{type:"text"}}},parameters:{docs:{page:null}}},i=({slotContent:r,heading:l,maxWidth:a,isHorizontallyCentered:s})=>`
