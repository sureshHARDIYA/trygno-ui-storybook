import{j as n}from"./jsx-runtime-KoT_NyIo.js";import{useMDXComponents as I}from"./index-BWyNtJX2.js";import{b as V,C as o}from"./blocks-CkFQ_0dF.js";import{I as R}from"./constants-C9b0xXi6.js";const X=t=>`
  <style>
  ...
  ${t()}
`,K={argTypes:{iconName:{options:R,control:{type:"select"}},iconColor:{options:["primary","secondary"],control:{type:"select"}},iconSize:{options:["small","medium","large"],control:{type:"select"}},variant:{options:["bordered","standard"],control:{type:"select"},default:"bordered"},hasNavIcon:{control:{type:"boolean"}}},title:"Components/Recipie/List/List Item",component:"trygno-list-element",parameters:{docs:{page:_}},decorators:[X]},U=({id:t,iconColor:e,iconName:O,iconSize:N,hasNavIcon:W,titleSlot:D,descriptionSlot:E,pillsSlot:A,rightTextSlot:B,variant:P="bordered"})=>`
    <trygno-list-element 
      id="${t}"
      icon-name="${O}"
      icon-color="${e}"
...
`,n.jsx(o,{of:l})]})}function _(t={}){const{wrapper:e}={...I(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(g,{...t})}):g(t)}const en=Object.freeze(Object.defineProperty({__proto__:null,default:_},Symbol.toStringTag,{value:"Module"}));export{en as D,nn as t};
