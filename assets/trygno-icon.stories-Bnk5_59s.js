import{I as i}from"./constants-Bp4En6Gj.js";const y={title:"Components/Core/Icon",component:"trygno-icon",tags:["autodocs"],argTypes:{name:{options:i,control:{type:"select"}},size:{control:{type:"text"}},color:{control:{type:"color"}},stroke:{control:{type:"color"}},label:{control:{type:"text"}}},parameters:{docs:{page:null}}},p=({name:r,size:c,color:s,stroke:l,label:a})=>`
    <trygno-icon
      name="${r}"
      size="${c}"
      color="${s}"
