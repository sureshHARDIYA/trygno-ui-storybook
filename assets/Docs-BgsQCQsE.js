import{j as e}from"./index-_k1vW10U.js";import{useMDXComponents as p}from"./index-DD0U_lpG.js";import{b as y,C as i,A as $}from"./blocks-CFSTINyu.js";const w={title:"Components/Core/Pagination",component:"trygno-pagination",argTypes:{pages:{control:"number",defaultValue:{summary:10},description:"The total number of pages",type:{name:"number",required:!0}},rangeSize:{control:"number",defaultValue:{summary:1},description:"The number of pages to display at once",type:{name:"number",required:!0}},current:{control:"number",defaultValue:{summary:1},description:"The current page",type:{name:"number",required:!0}},hideFirstButton:{control:"boolean",defaultValue:{summary:!1},description:"Hides the first page button",type:{name:"boolean"}},hideLastButton:{control:"boolean",defaultValue:{summary:!1},description:"Hides the last page button",type:{name:"boolean"}},hideEllipsis:{control:"boolean",defaultValue:{summary:!1},description:"Hides the ellipsis",type:{name:"boolean"}},hideInactiveArrows:{control:"boolean",defaultValue:{summary:!1},description:"Hides the inactive arrows",type:{name:"boolean"}}},parameters:{docs:{page:g}}},h=({pages:t,rangeSize:n,current:m,hideFirstButton:x,hideLastButton:j,hideEllipsis:f,hideInactiveArrows:b})=>`
    <trygno-pagination
      pages="${t}"
      range-size="${n}"
      current="${m}"
      ...
      hide-last-button="${j}"
      hide-ellipsis="${f}"
      hide-inactive-arrows="${b}"
      style="margin: 2rem"
    ></trygno-pagination>
  `,s=h.bind({});s.args={pages:10,rangeSize:1,current:1,hideFirstButton:!1,hideLastButton:!1,hideEllipsis:!1,hideInactiveArrows:!1};const r=h.bind({});r.args={pages:10,rangeSize:1,current:1,hideFirstButton:!0,hideLastButton:!0,hideEllipsis:!1,hideInactiveArrows:!1};const a=h.bind({});a.args={pages:100,rangeSize:2,current:50,hideFirstButton:!1,hideLastButton:!1,hideEllipsis:!0,hideInactiveArrows:!1};const o=h.bind({});o.args={pages:10,rangeSize:1,current:1,hideFirstButton:!1,hideLastButton:!1,hideEllipsis:!1,hideInactiveArrows:!0};const d=h.bind({});d.args={pages:100,rangeSize:2,current:1,hideFirstButton:!1,hideLastButton:!1,hideEllipsis:!1,hideInactiveArrows:!1};const l=h.bind({});l.args={pages:20,rangeSize:2,current:10,hideFirstButton:!1,hideLastButton:!1,hideEllipsis:!1,hideInactiveArrows:!1};const c=h.bind({});c.args={pages:20,rangeSize:2,current:20,hideFirstButton:!1,hideLastButton:!1,hideEllipsis:!1,hideInactiveArrows:!1};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`({
  pages,
  rangeSize,
  current,
  hideFirstButton,
  ...
  hideInactiveArrows
    ...
    <trygno-pagination
      ...
      style="margin: 2rem"
    ></trygno-pagination>
  \``,...c.parameters?.docs?.source}}};const v=["Default","NoFirstOrLastArrows","HideEllipsis","HideInactiveArrows","ManyPages","MiddlePage","LastPage"],B=Object.freeze(Object.defineProperty({__proto__:null,Default:s,HideEllipsis:a,HideInactiveArrows:o,LastPage:c,ManyPages:d,MiddlePage:l,NoFirstOrLastArrows:r,__namedExportsOrder:v,default:w},Symbol.toStringTag,{value:"Module"}));function u(t){const n={br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...p(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(y,{title:"Components/Core/Pagination"}),`
...
el.setLast();
`})}),`
`,e.jsxs(n.p,{children:["These methods will update the component and emit the ",e.jsx(n.code,{children:"update"})," event as if the user interacted with the UI."]})]})}function g(t={}){const{wrapper:n}={...p(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(u,{...t})}):u(t)}const z=Object.freeze(Object.defineProperty({__proto__:null,default:g},Symbol.toStringTag,{value:"Module"}));export{z as D,B as T};
