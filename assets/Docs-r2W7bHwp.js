import{j as e}from"./index-_k1vW10U.js";import{useMDXComponents as p}from"./index-DD0U_lpG.js";import{b as y,C as i,A as $}from"./blocks-DuRSde4i.js";const w={title:"Components/Core/Pagination",component:"trygno-pagination",argTypes:{pages:{control:"number",defaultValue:{summary:10},description:"The total number of pages",type:{name:"number",required:!0}},rangeSize:{control:"number",defaultValue:{summary:1},description:"The number of pages to display at once",type:{name:"number",required:!0}},current:{control:"number",defaultValue:{summary:1},description:"The current page",type:{name:"number",required:!0}},hideFirstButton:{control:"boolean",defaultValue:{summary:!1},description:"Hides the first page button",type:{name:"boolean"}},hideLastButton:{control:"boolean",defaultValue:{summary:!1},description:"Hides the last page button",type:{name:"boolean"}},hideEllipsis:{control:"boolean",defaultValue:{summary:!1},description:"Hides the ellipsis",type:{name:"boolean"}},hideInactiveArrows:{control:"boolean",defaultValue:{summary:!1},description:"Hides the inactive arrows",type:{name:"boolean"}}},parameters:{docs:{page:g}}},h=({pages:t,rangeSize:n,current:m,hideFirstButton:x,hideLastButton:j,hideEllipsis:f,hideInactiveArrows:b})=>`
    <trygno-pagination
      pages="${t}"
      range-size="${n}"
      current="${m}"
