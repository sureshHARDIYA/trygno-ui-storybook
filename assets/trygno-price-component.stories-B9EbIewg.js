const j={title:"Components/Shared/Price/Price Component",component:"trygno-price-component",tags:["autodocs"],argTypes:{totalPriceText:{control:{type:"text"},description:"Text to display for the total price"},oldPriceText:{control:{type:"text"},description:"Text to display for the old price"},suffix:{control:{type:"text"},description:"Suffix which appends with price, it could kr/mnd or kr"},priceValue:{control:{type:"number"},description:"Value of the current price"},oldPriceValue:{control:{type:"number"},description:"Value of the old price"},isLoadingDetails:{control:{type:"boolean"},description:"Whether the price details are loading"},isSticky:{control:{type:"boolean"},description:"decides if the price component should be sticky"}}},f=({totalPriceText:i,oldPriceText:t,priceValue:r,oldPriceValue:o,isLoadingDetails:n,suffix:c,isSticky:a})=>`
...
\``,...(F=(O=e.parameters)==null?void 0:O.docs)==null?void 0:F.source}}};var I,C,_;x.parameters={...x.parameters,docs:{...(I=x.parameters)==null?void 0:I.docs,source:{originalSource:`({
  ...
  <trygno-price-component
    ...
    is-sticky="\${isSticky}"
  ><p slot="price-spinner">Loading spinner slot</p></trygno-price-component>
\``,...(_=(C=x.parameters)==null?void 0:C.docs)==null?void 0:_.source}}};const q=["DefaultStickyPrice","StickyWithOldPrice","DefaultPrice","WithOldPrice","DefaultPriceWithAdditionalInfo","WithOldPriceAndAdditionalInfo","WithOldPriceWithSpinner"];export{p as DefaultPrice,u as DefaultPriceWithAdditionalInfo,l as DefaultStickyPrice,s as StickyWithOldPrice,d as WithOldPrice,e as WithOldPriceAndAdditionalInfo,x as WithOldPriceWithSpinner,q as __namedExportsOrder,j as default};
